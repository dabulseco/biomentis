...
**Location**: `biomentis/know_how/resource/addgene_grna_sequences.csv`
...
Use `advanced_web_search_claude` from `biomentis.tool.literature` to find validated sgRNAs from literature and databases:

```python
from biomentis.tool.literature import advanced_web_search_claude
...
**All 238 download links are available in**: `biomentis/know_how/resource/CRISPick_download_links.txt`
...
grep "9606_GRCh38_SpyoCas9_CRISPRko" biomentis/know_how/resource/CRISPick_download_links.txt

# Or for mouse
grep "10090_GRCm38_SpyoCas9_CRISPRko" biomentis/know_how/resource/CRISPick_download_links.txt
```
