...
Functions return research-log style strings to match Biomentis tool patterns.
"""
...
def list_glycoengineering_resources() -> str:
    ...
    lines.append("- For tight Biomentis integration, consider adding MCP wrappers or CLI installers.")
    return "\n".join(lines)
