...
def _process_ddinter_data_inline(data_lake_path, output_dir):
    ...
    data structures for use in Biomentis drug-drug interaction analysis.
...
def query_drug_interactions(drug_names, interaction_types=None, severity_levels=None, data_lake_path=None):
    ...
    if data_lake_path is None:
        # Default path assuming standard Biomentis structure
...
class OpenFDAClient:
    ...
    def __init__(self):
        ...
        self.session.headers.update({"User-Agent": "Biomentis-Agent/1.0 (https://github.com/dabulseco/biomentis)"})
