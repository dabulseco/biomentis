description = [
    ...
    {
        "description": "Read the contents of a local protocol file from biomentis/tool/protocols/. Use list_local_protocols() first to find available protocol filenames.",
