...
def generate_api_docs(base_path, output_dir, package_name, exclude_list=None):
    ...
    Args:
        base_path (str): The root directory of the Python package (e.g., 'biomentis').
    ...
    for root, dirs, files in os.walk(base_path):
        ...
        for file in files:
            ...
            if file.endswith(".py") and file != "__init__.py":
                # Construct the full module name (e.g., biomentis.agent.a1)
...
if __name__ == "__main__":
    package_to_document = "../biomentis"
    api_docs_path = "./source/api"
    package_name = "biomentis"
